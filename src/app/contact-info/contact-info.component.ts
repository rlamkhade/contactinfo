...
export class ContactInfoComponent implements OnInit {
  ...
  */
  onSubmit() {
    ...
    this.spinner.show();
    //if current action is Edit Contact then take id from submitted form values. And if action is Add Contact then take last id value and +1 in that to get unique id.
